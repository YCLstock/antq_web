...
<!-- Footer with Contact Information and Copyright -->
  ...
  <div class="container px-6 pt-6">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3">
      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase">COMPANY</h5>
      ...
      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase">CUSTOMER SERVICE</h5>
      ...
      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase">MORE TO EXPLORE</h5>

        <ul class="mb-0 list-none">
          <li>
            <a href="#!">Beauty Magazine</a>
          </li>
          <li>
            <a href="#!">Tool and consultations</a>
          </li>
          <li>
            <a href="#!">Offers</a>
          </li>
          <li>
            <a href="#!">#LorealParis</a>
          </li>
        </ul>
      </div>
    </div>
